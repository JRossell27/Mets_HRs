diff --git a/mlb_monitor.py b/mlb_monitor.py
index 85f88b496a9dd36f9f742de5c3e0f970d7ca4cfe..3272b10c154cfcee318bc8727aed759525a8a12f 100644
--- a/mlb_monitor.py
+++ b/mlb_monitor.py
@@ -42,80 +42,152 @@ PITCH_TYPE_LABELS = {
     "CU": "Curveball",
     "CH": "Changeup",
     "FS": "Splitter",
     "KC": "Knuckle Curve",
...
@@ -157,202 +229,242 @@ class MLBMonitor:
         try:
             players = (
                 feed.get("liveData", {})
                     .get("boxscore", {})
