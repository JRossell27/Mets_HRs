...
def format_update_message(challenge: dict) -> str:
    ...
    return discord_message
diff --git a/message_formatter.py b/message_formatter.py
index aaaed49b0aa1c3c9e80714451ea6812f4b95ce7a..72b89e26539ec7ef6449bd844b3e91f43d8d572a 100644
--- a/message_formatter.py
+++ b/message_formatter.py
@@ -10,50 +10,75 @@ TEAM_HASHTAGS = {
     "NYM": "#LGM",       "NYY": "#RepBX",    "BOS": "#RedSox",
     "TOR": "#BlueJays",  "BAL": "#Orioles",  "TB": "#RaysUp",
     "HOU": "#Astros",    "LAA": "#Angels",   "OAK": "#Athletics",
     "SEA": "#Mariners",  "TEX": "#Rangers",  "CWS": "#WhiteSox",
...
+
 ...
 def _hashtags(away_abbr: str, home_abbr: str) -> str:
     ...
     tags.append("#MLB")
     return " ".join(tags)
@@ -75,86 +100,75 @@ def _challenger_stat_line(challenge: dict) -> str:
     return f"📊 {name} ({role}) 2026: {pct:.1f}% ({overturned}/{challenges} overturned)"
